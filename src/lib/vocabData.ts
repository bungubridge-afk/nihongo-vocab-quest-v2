...
export const vocabData: VocabItem[] = [
  ...
  // --- Freunde ---
  {
    ...
    shortTip: "„友だち“ selbst ist weder locker noch höflich – das entscheidet der Satz.",
    detailTip:
    ...
    usageExamples: [
      {
        id: "friend-meeting-today-casual",
        japanese: "今日、友だちに会う。",
        kana: "きょう、ともだちにあう。",
        romaji: "kyou, tomodachi ni au",
        german: "Heute treffe ich einen Freund.",
        register: "casual",
        suitableFor: ["friend", "family", "classmate"],
        contextGerman: "Du sprichst locker mit einem Freund oder Mitschüler.",
        noteGerman: "Die einfache Form „会う“ klingt unter Freunden ganz normal.",
        contrastGroup: "meeting-a-friend-today",
      },
      {
        id: "friend-meeting-today-polite",
        ...
        contextGerman:
          "Du sprichst höflich mit einer Lehrkraft oder einer weniger vertrauten Person.",
        noteGerman: "Mit „-masu“ ist die Aussage auch für weniger vertraute Personen passend.",
        contrastGroup: "meeting-a-friend-today",
      },
    ],
  },
  {
    ...
    shortTip: "„会う“ + „に“ zeigt, wen du triffst – locker oder höflich.",
    detailTip:
    ...
    usageExamples: [
      {
        ...
        register: "casual",
        suitableFor: ["friend", "family", "classmate"],
        contextGerman: "Du erzählst locker von deinen Plänen.",
        noteGerman: "Die Wörterbuchform „会う“ ist im lockeren Gespräch die natürliche Wahl.",
        contrastGroup: "meeting-a-friend",
      },
      {
        id: "meet-friend-polite",
        japanese: "友だちに会います。",
        kana: "ともだちにあいます。",
        ...
        suitableFor: ["teacher", "stranger", "work"],
        contextGerman: "Du sprichst höflich, zum Beispiel mit einer Lehrkraft.",
        noteGerman: "„会います“ bleibt höflich, auch wenn die Person, die du triffst, ein Freund ist.",
        contrastGroup: "meeting-a-friend",
      },
    ],
  },
  {
    ...
    shortTip: "„と話す“ heißt „mit jemandem sprechen“ – lockerer oder höflicher, je nach Satzende.",
    detailTip:
    ...
    usageExamples: [
      {
        id: "talk-with-friend-casual",
        japanese: "友だちと話す。",
        kana: "ともだちとはなす。",
        romaji: "tomodachi to hanasu",
        german: "Ich spreche mit einem Freund.",
        register: "casual",
        suitableFor: ["friend", "family", "classmate"],
        contextGerman: "Du sprichst locker mit einem Freund oder Mitschüler.",
        noteGerman: "Ohne „です/ます“ klingt der Satz unter Freunden entspannt, nicht unhöflich.",
        contrastGroup: "talking-with-a-friend",
      },
      {
        id: "talk-with-friend-polite",
        japanese: "友だちと話します。",
        kana: "ともだちとはなします。",
        ...
        suitableFor: ["teacher", "stranger", "work"],
        contextGerman: "Du sprichst höflich, zum Beispiel mit einer Lehrkraft.",
        noteGerman: "„話します“ passt, wenn du in einer etwas formelleren Situation bist.",
        contrastGroup: "talking-with-a-friend",
      },
    ],
  },
  {
    ...
    shortTip: "„明日“ steht am Satzanfang – der Ton kommt vom Verb danach.",
    detailTip:
    ...
    usageExamples: [
      {
        id: "tomorrow-meeting-friend-casual",
        japanese: "明日、友だちに会う。",
        kana: "あした、ともだちにあう。",
        romaji: "ashita, tomodachi ni au",
        german: "Morgen treffe ich einen Freund.",
        register: "casual",
        suitableFor: ["friend", "family", "classmate"],
        contextGerman: "Du erzählst einem Freund locker von deinen Plänen für morgen.",
        noteGerman: "Zukunftspläne beschreibst du im Japanischen mit derselben Verbform wie die Gegenwart.",
        contrastGroup: "meeting-a-friend-tomorrow",
      },
      {
        id: "tomorrow-meeting-friend-polite",
        japanese: "明日、友だちに会います。",
        kana: "あした、ともだちにあいます。",
        romaji: "ashita, tomodachi ni aimasu",
        german: "Morgen treffe ich einen Freund.",
        register: "polite",
        suitableFor: ["teacher", "stranger", "work"],
        contextGerman: "Du sprichst höflich über deine Pläne, zum Beispiel mit einer Lehrkraft.",
        noteGerman: "„-masu“ macht die Aussage höflich, ohne den Inhalt zu verändern.",
        contrastGroup: "meeting-a-friend-tomorrow",
      },
    ],
  },
  {
    ...
    shortTip: "Bei „好き“ bleibt „が“ gleich – nur „です“ macht den Unterschied.",
    detailTip:
    ...
    usageExamples: [
      {
        id: "like-friends-casual",
        japanese: "友だちが好き。",
        kana: "ともだちがすき。",
        romaji: "tomodachi ga suki",
        german: "Ich mag meine Freunde.",
        register: "casual",
        suitableFor: ["friend", "family", "classmate"],
        contextGerman: "Du sprichst locker mit einem Freund oder einer Freundin.",
        noteGerman: "Ohne „です“ klingt „好き“ unter Freunden natürlich und nicht abgehackt.",
        contrastGroup: "liking-friends",
      },
      {
        id: "like-friends-polite",
        japanese: "友だちが好きです。",
        kana: "ともだちがすきです。",
        romaji: "tomodachi ga suki desu",
        german: "Ich mag meine Freunde.",
        register: "polite",
        suitableFor: ["teacher", "stranger", "work"],
        contextGerman: "Du sprichst höflich, zum Beispiel mit einer neuen Bekanntschaft.",
